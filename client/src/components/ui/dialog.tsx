...
function isDialogDescriptionElement(node: React.ReactNode): boolean {
...
export function hasDialogDescription(children: React.ReactNode): boolean {
  let found = false
  React.Children.forEach(children, (child) => {
    if (found) return
    if (isDialogDescriptionElement(child)) {
      found = true
    }
  })
  return found
...
>(({ className, children, ...props }, ref) => {
  const contentAccessibilityProps = props["aria-describedby"] !== undefined
