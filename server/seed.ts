...
const DEFAULT_ORDER_FIELDS = [
  { fieldKey: "cliente", label: "Cliente", fieldType: "TEXT", required: true, sortOrder: 0, isSystemDefault: true },
  { fieldKey: "telefono", label: "Teléfono", fieldType: "TEXT", required: false, sortOrder: 1, isSystemDefault: true },
  { fieldKey: "descripcion", label: "Descripción", fieldType: "TEXT", required: false, sortOrder: 2, isSystemDefault: true },
] as const;
  ...
  try {
    ...
    await db
      ...
      .values({
        ...
        limitsJson: {
          customers_max: 50, branches_max: 1, max_branches: 1, cashiers_max: 0,
    ...
    await db
      ...
      .values({
        ...
        limitsJson: {
          ...
          tracking_retention_min_hours: 1, tracking_retention_max_hours: 128,
        },
        priceMonthly: "9999",
        allowCashiers: true,
        isActive: true,
    ...
    console.log("---");
    console.log("Super Admin: Use CLI para crear.");
