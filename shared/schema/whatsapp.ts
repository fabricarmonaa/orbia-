...
export const tenantWhatsappAutomationConfigs = pgTable("tenant_whatsapp_automation_configs", {
  ...
  webhookUrlProduction: text("webhook_url_production"),
  signingSecretEncrypted: text("signing_secret_encrypted"),
  rulesEnabled: boolean("rules_enabled").notNull().default(true),
  handoffOnUnknown: boolean("handoff_on_unknown").notNull().default(false),
  genericFallbackReply: text("generic_fallback_reply"),
